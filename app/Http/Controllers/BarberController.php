...
class BarberController extends Controller
{
    ...
    */
    ...
    /**
     *
     * VARIAVEL DE AMBIENTE: MAPS_KEY criado dentro de .env
     *
     * Função privada para fazer processo de requisição.
     *
     * 1. Funcionalidade: Se eu mandar uma cidade ela vai me retornar o resultado em formato de geolocalização, onde esta essa cidade, país e etc...
     * 2. Funcionalidade: Se eu mandar uma localização, latitude, longitude ela vai me retornar as mesmas informações: nome da cidade, país  e etc.
     *
     */
    ...
    public function list(Request $request) {
        ...
        /**
         * Corrigi a url do avatar do Barbeiro com a URL completa.
         * Anteriormente ele pegava por exemplo:
         * 2.png
         */
